...
## Project Structure
    ...
    ├── testapiautosettings_85481  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_85481`
...
2. Clone this repo and `cd testapiautosettings_85481`
